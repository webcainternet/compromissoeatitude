...
function themify_get_skins(){
	...
	$output = '<input type="hidden" name="skin" value="' . esc_attr( themify_get( 'skin' ) ) . '">';
...
function themify_before_meta_field($args){
	...
	if ( isset( $meta_box['title'] ) ) {
		$html .= '<div class="themify_field_title">' . $meta_box['title'] . '</div>';
	}
	$html .= '<div class="themify_field themify_field-'.$meta_box['type'].'">';
		...
		if ( isset( $src ) && $src != '' && $src ) {
			...
			if ( ! empty( $img_url ) ) {
				if ( isset( $urlonly ) ) {
					...
					return stripslashes( $before ) . "<img src='$img_url' alt='$alt' $class $id $p_width $p_height />" . stripslashes( $after );
				}
			}
		}
		return '';
