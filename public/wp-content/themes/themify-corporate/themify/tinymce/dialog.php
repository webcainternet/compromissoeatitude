...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" href="<?php echo THEMIFY_URI . '/css/themify-ui.css'; ?>"/>
		<link rel="stylesheet" href="<?php echo THEMIFY_URI . '/fontawesome/css/font-awesome.min.css'; ?>"/>
		<link rel="stylesheet" href="<?php echo THEMIFY_URI . '/themify-icons/themify-icons.css'; ?>"/>
		<style type="text/css">
		body#wp-admin {
			margin: 10px 17px;
			padding-bottom: 10px ;
		...
		<script src="<?php echo THEMIFY_URI . '/js/themify.font-icons-select.js'; ?>"  type="text/javascript" ></script>
		<base target="_self" />
	</head>
				...
				<p>
					...
					<?php }	?>
						...
						<?php
							...
							$field['id'], $field['id'], 'small', $field['id'], __( 'Insert Icon', 'themify' ) );
						}
						?>
					<?php if(isset($field['id']) && isset($field['label'])){ ?>
					</label>
