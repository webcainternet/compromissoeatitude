...
<div id="layout" class="pagewidth clearfix">
	...
	<div id="content" class="clearfix">
		...
		?>
		<?php if(is_search()): ?>
			<h1 class="page-title"><?php _e('Resultado de busca por:','themify'); ?> <em><?php echo get_search_query(); ?></em></h1>
		<?php endif; ?>
		...
		<?php else : ?>
			...
			<p><?php _e( 'Desculpe, não foram encontrados resultados para esta busca no momento.', 'themify' ); ?></p>
