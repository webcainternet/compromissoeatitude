...
class Themify_Builder_Layouts {
	...
	function layout_part_info() {
		...
		echo '<div>' . __( 'To display this Layout Part, insert this shortcode:', 'themify' ) . '<br/><span class="code">[themify_layout_part id="' . $layout_part->ID . '"]</span>';
		if ( ! empty( $layout_part->post_name ) ) {
			echo  '<div class="themify-layout-part-slug-block">' . __( 'or', 'themify' ) . '<br/><span class="code">[themify_layout_part slug="<span class="themify-layout-part-slug">' . $layout_part->post_name . '"]</span></span></div>';
		}
		echo '</div>';
	}
