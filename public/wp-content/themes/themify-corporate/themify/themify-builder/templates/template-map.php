	...
	<?php $num = rand(0,10000); ?>
		<script type="text/javascript"> 
			function themify_builder_create_map() {
				ThemifyBuilderModuleJs.initialize("<?php echo $geo_address; ?>", <?php echo $num; ?>, <?php echo $zoom_map; ?>, "<?php echo $type_map; ?>", <?php echo $scrollwheel_map != 'enable' ? 'false' : 'true' ; ?>, <?php echo $draggable_map != 'enable' ? 'false' : 'true' ; ?>);
			}
		...
		<div id="themify_map_canvas_<?php echo $num; ?>" style="<?php echo $style; ?>" class="map-container" data-info-window="<?php echo esc_attr( $info_window_map ); ?>" data-reverse-geocoding="<?php echo ( empty( $address_map ) && ! empty( $latlong_map ) ) ? true: false; ?>">&nbsp;</div>
	<?php
	}
	?>
</div>
