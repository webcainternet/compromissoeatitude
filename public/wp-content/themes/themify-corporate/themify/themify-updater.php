		...
		if ( is_object( $newT ) && ( $theme_version < $newT->version ) ) {
			if ( $_GET['page'] == 'themify' ) {
				if ( isset( $area ) && 'tab' == $area ) {
					$theme_notifications = sprintf( __( '<p class="update %s"><a href="%s" title="" class="%s updateready" target="%s">Update Now</a></p> <p>%s version %s is now available. View the <a href="http://themify.me/logs/%s-changelogs" target="_blank"
