	...
	<table class="form-table itsec-settings-section">
		...
		<tr>
			...
			<td>
				...
				<p class="description"><?php printf( __( 'This feature will trigger an email to be sent to the <a href="%s">notifications email address</a> whenever a host or user is locked out of the system.', 'better-wp-security' ), admin_url( 'admin.php?page=toplevel_page_itsec_settings' ) ); ?></p>
			</td>
		</tr>
		<tr>
